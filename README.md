...
<details open="open">
  ...
  <ol>
    ...
    <li><a href="#Data Transformation and Feature Engineering">Data Transformation</a></li>
    <li><a href="#Machine Learning Algorithm: Predicting Absenteeism">Model Selection</a></li>
